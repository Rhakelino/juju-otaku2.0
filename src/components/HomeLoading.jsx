...
const HomeLoading = () => {
    return (
        <div className="container mx-auto px-4 py-8 bg-neutral-900 min-h-screen">
            <div className="mb-8">
                {/* Judul */}
                <div className="h-10 w-1/2 md:w-1/4 ml-16 bg-neutral-700 rounded-lg mb-8"></div>

                {/* Search Input Skeleton */}
                <div className="mb-8 flex">
                    <div className="w-full md:mx-16 max-w-lg flex">
                        <div className="flex-grow h-10 bg-neutral-700 rounded-l-lg"></div>
                        <div className="w-24 h-10 bg-neutral-700 rounded-r-lg"></div>
                    </div>
                </div>
                {[1, 2].map((section) => (
                    <div key={section} className="mb-8 mx-16">
